"""Scraper for the Tribunal de Justica do Ceara (TJCE)."""
import logging
import shutil
...
logger = logging.getLogger("juscraper.tjce")


class TJCEScraper(BaseScraper):
    """Scraper for the Tribunal de Justica do Ceara (TJCE).

    The TJCE uses the eSAJ platform (same as TJSP).
    ...
    def cjsg(
        ...
        **kwargs,
        ...
        """Search TJCE jurisprudence (2nd degree).
