"""Scraper for the Tribunal de Justica do Acre (TJAC)."""
import logging
import shutil
...
logger = logging.getLogger("juscraper.tjac")


class TJACScraper(BaseScraper):
    """Scraper for the Tribunal de Justica do Acre (TJAC).

    The TJAC uses the eSAJ platform (same as TJSP).
    ...
    def cjsg(
        ...
        **kwargs,
        ...
        """Search TJAC jurisprudence (2nd degree).
