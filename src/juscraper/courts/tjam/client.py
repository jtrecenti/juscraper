"""Scraper for the Tribunal de Justica do Amazonas (TJAM)."""
import logging
import shutil
...
logger = logging.getLogger("juscraper.tjam")


class TJAMScraper(BaseScraper):
    """Scraper for the Tribunal de Justica do Amazonas (TJAM).

    The TJAM uses the eSAJ platform (same as TJSP).
    ...
    def cjsg(
        ...
        **kwargs,
        ...
        """Search TJAM jurisprudence (2nd degree).
